...
export class HalResource implements IHalResource {
    ...
    public fetch(forceOrParams ?: boolean | object): Promise<this> {
        return (this.isLoaded && !forceOrParams) || this.uri === undefined ? new Promise((resolve) => resolve(this)) : this.restClient.fetch(
    ...
    private serialize(props: string[], links: string[], serializer: IJSONSerializer = new DefaultSerializer()): object {
        ...
        for (const prop of props) {
            ...
            json[jsonKey] = this.props[prop] !== undefined && this.props[prop] !== null && this.props[prop].onInitEnded !== undefined ? serializer.parseResource(this.props[prop]) : serializer.parseProp(this.props[prop]);
        }
